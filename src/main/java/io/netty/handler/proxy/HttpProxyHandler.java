...
public final class HttpProxyHandler extends ProxyHandler {
    ...
    private final boolean ignoreDefaultPortsInConnectHostHeader;    private HttpResponseStatus status;
    ...
    protected Object newInitialMessage(ChannelHandlerContext ctx) throws Exception {
        ...
        /**
         * Netty的源码这里支持性不好，进行修改一下，代理服务器一般要接收大写的Host，除非Http代理服务器自己有支持小写的host传递.
         */
